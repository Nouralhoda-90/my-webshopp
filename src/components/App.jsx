...
export default function App() {
  ...
  const handleSort = (sortType) => {
    setSortType(sortType); // Update sort type state
  };

  return (
    <div>
      <Navbar cartCount={cartCount} onProductsClick={() => setCurrentPage('products')} onCartClick={() => setCurrentPage('cart')} onSearch={handleSearch} onSort={handleSort} />
